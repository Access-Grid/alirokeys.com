module ApplicationHelper
  # Inline SVG icons (Heroicons-style, currentColor). Sized 1em by default.
  ICONS = {
    ...
    key: %(<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H9v1.5H7.5v1.5H6v1.5H3.375A1.125 1.125 0 0 1 2.25 20.625v-2.872c0-.298.119-.585.33-.796l5.84-5.84a.926.926 0 0 0 .43-1.563A6 6 0 1 1 21.75 8.25Z" />),
    arrow_right: %(<path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />),
    ...
    fire: %(<path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 18a3.75 3.75 0 0 0 .495-7.467 5.99 5.99 0 0 0-1.925 3.546 5.974 5.974 0 0 1-2.133-1.001A3.75 3.75 0 0 0 12 18Z" />),
  ...
  def icon(name, classes: "h-4 w-4")
    tag.svg(ICONS.fetch(name).html_safe,
      xmlns: "http://www.w3.org/2000/svg", "viewBox": "0 0 24 24",
      fill: "none", stroke: "currentColor", "stroke-width": "1.8",
      class: classes)
  end

  def copy_icon = icon(:copy)
  def download_icon = icon(:download)
end
